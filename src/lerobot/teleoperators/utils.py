...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    elif config.type == "openarm_rosbridge_bimanual_teleop":
        from .openarm_rosbridge_bimanual import OpenArmRosbridgeBimanualTeleop

        return OpenArmRosbridgeBimanualTeleop(config)
